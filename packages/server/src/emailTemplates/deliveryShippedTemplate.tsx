...
export const DeliveryShippedEmail: React.FC<DeliveryEmailProps> = ({ delivery }) => {
  ...
  return <BaseEmailTemplate mainContent={mainContent} deliveryContent={defaultDeliveryContent(delivery)} footerContent={null} delivery={delivery} preview={"Get your order summary, estimated delivery date and more"}/>;
};
