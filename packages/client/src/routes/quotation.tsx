...
const quotation: React.FC = () => {
  ...
  const calculateShippingCost = () => {
    let baseCost = destination === "inside" ? 0.5 : 5;
    let weightCost = weight * 5;
    let expressCost = isExpress ? 15 : 0;
    const totalCost = baseCost + weightCost + expressCost;
    setCost(totalCost);
  };
        ...
        <div className="mb-6 p-4 border border-gray-200 rounded bg-blue-50">
          ...
          <div className="flex flex-col space-y-3 text-sm">
            <div className="flex items-center space-x-2">
              ...
              <span>
                <strong>Destination:</strong> Ship within Canada for only $0.50, or send it internationally for just $5!
              </span>
            </div>
            <div className="flex items-center space-x-2">
              ...
              <span>
                <strong>Weight:</strong> Larger packages may need a little extra to cover the journey, but we’ve got you covered at $5/kg.
              </span>
            </div>
            <div className="flex items-center space-x-2">
              ...
              <span>
                <strong>Express Shipping:</strong> Add an extra $15 for express delivery to ensure your package arrives on time!
              </span>
            </div>
          </div>
        </div>
