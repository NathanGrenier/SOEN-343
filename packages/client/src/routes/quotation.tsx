...
const quotation: React.FC = () => {
  ...
  const calculateShippingCost = () => {
    let baseCost = destination === "inside" ? 10 : 20;
        ...
        <div className="mb-6 p-4 border border-gray-200 rounded bg-blue-50">
          ...
          <div className="flex flex-col space-y-3 text-sm">
            <div className="flex items-center space-x-2">
              ...
              <span><strong>Destination:</strong> Ship within Canada for a lower rate, or send it internationally for only a bit more adventure!</span>
            </div>
            <div className="flex items-center space-x-2">
...
export default quotation;
>>>>>>> b6414c6c59d799178400ad0f1104173436a368a1
